...
const options = {
  method: "GET",
  headers: {
    'X-RapidAPI-Key': '906cdb1a5bmsh375d9f34bf3a2fep1dd78fjsn696c28ef155a',
...
[{
      "id": "39618986",
      "url2": "https://www.airbnb.com/rooms/39618986",
...
const id = parsedData.data[0].id;
const url2 = parsedData.data[0].url2;
const name = parsedData.data[0].name;
const city = parsedData.data[0].city;

const images = parsedData.data[0].images;


const price = parsedData.data[0].price;
const rate = price.rate;
const currency = price.currency;
const total = price.total;

const amenityIds = parsedData.data[0].amenityIds;
const previewAmenities = parsedData.data[0].previewAmenities;
